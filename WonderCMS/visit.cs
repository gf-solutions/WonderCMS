...
namespace WonderCMS
{
    ...
    {
        public int visit_id;
        public KeyValuePair<int, string> patient, nurse, doctor;
        public DateTime date;
        public string reasons, diagnosis, notes;

        public visit(int visit_id, int patient_id, string patient_name, int nurse_id, string nurse_name, int doctor_id, string doctor_name, DateTime date, string reasons, string diagnosis, string notes)
        {
